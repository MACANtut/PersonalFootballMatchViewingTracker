...
class MainWindow(QMainWindow):
    def __init__(self, user_data=None, db=None):
        ...
        # Кнопки, видимые только для администратора
        if self.is_admin:
        ...
        # СОЗДАЕМ И ДОБАВЛЯЕМ EVENTSWINDOW СРАЗУ
        ...
        # Устанавливаем текущий виджет на events_widget
    ...
    def open_events_window(self):
        """Открывает окно событий в правой панели"""
        ...
        if hasattr(self, 'background_pixmap') and self.background_pixmap:
            self.events_widget.set_background_pixmap(self.background_pixmap)
    ...
    def open_users_window(self):
        """Открывает окно пользователей в правой панели (только для админа)"""
    ...
    def open_players_window(self):
        """Открывает окно игроков в правой панели (только для админа)"""
        if not self.is_admin:
            return
    ...
    def open_clubs_window(self):
        """Открывает окно клубов в правой панели (только для админа)"""
        if not self.is_admin:
            return
...
class LoginWindow(QWidget):
    ...
    def login(self):
        ...
        if success:
            # Добавляем username в user_data
