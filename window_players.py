...
class PlayersWindow(QDialog):
    def __init__(self, is_admin=False, parent=None, user_data=None, db=None):
        super().__init__(parent)
        # Кнопка добавления видна для ВСЕХ пользователей
        self.is_admin = True  # Принудительно устанавливаем True, чтобы кнопка была видна
    ...
    def initUI(self):
        ...
        header.setSectionResizeMode(2, QHeaderView.ResizeToContents)  # Дата рождения - по содержимому
        header.setSectionResizeMode(3, QHeaderView.Stretch)  # Клуб
        header.setSectionResizeMode(4, QHeaderView.Fixed)  # Фото - фиксированная
        
        # Устанавливаем фиксированную ширину для колонки Фото
        ...
        # Кнопка добавления игрока - ВИДНА ДЛЯ ВСЕХ
