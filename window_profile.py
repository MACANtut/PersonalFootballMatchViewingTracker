...
class ProfileWindow(QDialog):
    ...
    def load_clubs(self):
        """Загружает список клубов из базы данных"""
        if self.db:
    ...
    def show_club_edit(self):
        """Показывает форму для смены клуба"""
        ...
        # Выбираем текущий клуб в комбобоксе
    ...
    def show_schedule_window(self):
        """Открывает окно графика просмотренных матчей"""
    ...
    # window_profile.py - добавьте этот метод в класс ProfileWindow
